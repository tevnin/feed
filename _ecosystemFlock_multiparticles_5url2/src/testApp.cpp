...
void testApp::setup(){
    ...
    if ((oldNum1/proportion)>2000) {
        oldNum1 = 100,000;
    }
    
    if ((oldNum2/proportion)>2000) {
        oldNum2 = 100,000;
    }
    
    if ((oldNum3/proportion)>2000) {
        oldNum3 = 100,000;
    }
    
    if ((oldNum4/proportion)>2000) {
        oldNum4 = 100,000;
    }
