...
void testApp::setup(){
    ...
    Archer.loadFont("GillSans.ttc", 21);
    Archer.setLineHeight(22);
    //GillBig.loadFont("GillSans.ttc", 22);
...
void testApp::draw(){
    ...
    ofSetColor(0, 0, 0);
    Archer.drawString("#FEEDmixer", ofGetWidth()-300, ofGetHeight()-70);
    Archer.drawString("one bird = 100 tweets", ofGetWidth()-300, ofGetHeight()-40);
