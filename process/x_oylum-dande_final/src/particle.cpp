...
void particle::draw(){
    ...
    ofRotateZ(angle * RAD_TO_DEG + 420);
        img->draw(0,0, 100, 100);
//    ofRotateZ(angle * RAD_TO_DEG + 420);
//    ofTranslate(0, 30);
        img1->draw(0,0, 130, 130);
	
	 ofPopMatrix();
//    ofPushMatrix();
//    ofTranslate(pos.x, pos.y, 0);
//    ofRotateZ(angle * RAD_TO_DEG + 450);
//    //img->draw(0,0, 100, 100);
//    img1->draw(100,0, 100, 100);
//	
//    ofPopMatrix();
}
...
//--------------------------------------------------------------
void particle::rotateFromPoint(float catchX, float catchY){
	
	
	//pos.x = catchUpSpeed * catchX + (1-catchUpSpeed) * pos.x; 
	//pos.y = catchUpSpeed * catchY + (1-catchUpSpeed) * pos.y; 
    
	float dx = pos.x - catchX;
	float dy = pos.y - catchY;
